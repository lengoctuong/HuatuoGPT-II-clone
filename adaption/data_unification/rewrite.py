...
class GPT:
    ...
    def call(self, content, args={}, showkeys=False):
        ...
        # Tạo object model từ langchain_openai
        llm = AzureChatOpenAI(
            api_version="2024-08-01-preview",
            azure_deployment=self.model_name,  # đây là deployment name trên Azure
            temperature=args.get("temperature", 0.7),
            api_key=self.api_key,              # Lưu trong class
            azure_endpoint=self.api_base       # endpoint: "https://<resource-name>.openai.azure.com/"
        )
        ...
        if isinstance(content, str):
            ...
            messages = content  # Nếu đã là list of messages (Message objects)
    ...
    def call2(self, content, args = {}, showkeys = False):
